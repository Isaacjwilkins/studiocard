...
export default function OnboardingModal({ isOpen, onClose, teacher }: OnboardingModalProps) {
    ...
    // Handle generic teacher object for guests
    const teacherName = teacher?.username || "demo-studio";
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div
                ...
                exit={{ opacity: 0 }}
                onClick={onClose}
                className="absolute inset-0 bg-zinc-50/90 dark:bg-black/90 backdrop-blur-md"
            />
            ...
            <motion.div
                ...
                className="w-full max-w-lg relative bg-white dark:bg-zinc-900 p-8 rounded-[2.5rem] shadow-2xl shadow-purple-500/20 border border-zinc-200 dark:border-white/5 z-10"
            >
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {step === 1 && (
                            ...
                            >
                                ...
                                {/* Replaced text with clickable link */}
                                <Link
                                    href={baseUrl ? `${baseUrl}/students` : "#"}
                                    className="inline-block text-[10px] font-bold text-zinc-400 uppercase tracking-widest hover:text-foreground transition-colors"
                                >
                                    or visit {baseUrl ? baseUrl.replace("https://", "") : "..."} /students
                                </Link>
                            </motion.div>
                        )}
                        ...
                        {step === 2 && (
                            ...
                            >
                                ...
                                <p className="text-zinc-500 font-medium px-4 text-sm leading-relaxed">
                                    ...
                                    <br /><span className="text-foreground font-bold">Important:</span> They must enter this exact code:
                                </p>
                                ...
                                <div className="w-full max-w-xs bg-zinc-50 dark:bg-black/40 p-6 rounded-2xl border-2 border-dashed border-zinc-200 dark:border-zinc-800">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-2">Code from your Teacher</p>
                        ...
                        {step === 4 && (
                            ...
                            >
                                ...
                                <p className="text-zinc-500 font-medium px-4 max-w-xs text-sm leading-relaxed mb-6">
                                    The student is now connected. Close this window to see the confetti!
                                </p>
